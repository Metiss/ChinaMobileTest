...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="operateradd.do">
      <p>登录ID：<input type="text" name="operator_id" size="20"></p>
      <p>姓 名：<input type="text" name="operator_name" size="20" ></p>
      <p>密码：<input type="password" name="operator_pwd" size="20" ></p>
      <p>密码确认：<input type="password" name="reoperator_pwd" size="20" ></p>
