...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <p>指定号段：从<input type="text" name="mobilenumberbegin" size="20">到<input type="text" name="mobilenumberend" size="20"><input type="submit" value="提交" name="btn_mobile"><input type="reset" value="全部重写" name="B2"></p>
    </form>
    <hr>
