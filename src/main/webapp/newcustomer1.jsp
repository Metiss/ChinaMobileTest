...
<TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
  ...
  <TR vAlign=top>
    ...
    <form method="POST" action="newcustomer1.do">
      <p><input type="hidden" name="customer_id" id="sp_place" value="${customer.customer_id}"/></p>
      <p>证件类型：${customer.id_type}<input type="hidden" name="id_type" value="${customer.id_type}"/></p>
      <p>证件号码：${customer.id_number}<input type="hidden" name="id_number" value="${customer.id_number}"/></p>
       <p>姓名：<input type="text" name="customer_name" size="20" value="${customer.customer_name}"></p>
      <p>性别：
      <c:choose>
      <c:when test="${customer.customer_sex=='男'}">
      	 <input type="radio" value="男" checked name="customer_sex">男&nbsp;&nbsp; <input type="radio" name="customer_sex" value="V2">女
      </c:when>
      <c:otherwise>
      	<input type="radio" value="男"  name="customer_sex">男&nbsp;&nbsp; <input type="radio" name="customer_sex" value="女" checked>女
      </c:otherwise>
      </c:choose>
     </p>
      <p>生日：<input type="text" name="customer_birthday" size="30" value="${customer.customer_birthday}"></p>
      <p>联系地址：<input type="text" name="customer_address" size="20" value="${customer.customer_address}"></p>
      <p>　</p>
